...
import es.daw.jakarta.services.ProductCSVServiceImpl;
...
@WebServlet({"/productos-csv"})
public class ProductCSVServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ProductService service = new ProductCSVServiceImpl();

        // Obtener la lista de productos
        List<Producto> productos = service.listar(getServletContext().getRealPath("/productos.csv"));
